...
curses.start_color()
curses.init_pair(1, curses.COLOR_BLACK, curses.COLOR_BLU)  # Text color, Background color
curses.init_pair(2, curses.COLOR_RED, curses.COLOR_GREEN)  # Food color
...
while True:
    ...
    if snake[0] == food:
        ...
        tail = snake.pop()
        w.addch(int(tail[0]), int(tail[1]), ' ', curses.color_pair(1))
